...
$string['eventmoodiyregistration_desc'] = 'User {$a->userid} has registered the site with id {$a->objectid} with Moodiy.';
$string['eventmoodiyregistrationupdated'] = 'Site registration updated with Moodiy';
$string['eventmoodiyregistrationupdated_desc'] = 'User {$a->userid} has updated the site registration with id {$a->objectid} with Moodiy.';
$string['eventmoodiyunregistration'] = 'Site unregistered from Moodiy';
...
$string['siteregistrationurlupdated'] = 'Site url updated with Moodiy.';
$string['skipregistration'] = 'Skip registration';
$string['tasksiteurlupdate'] = 'Site URL update with Moodiy';
$string['unregister'] = 'Unregister';
$string['unregistrationerror'] = 'An error occurred while attempting to unregister the site: {$a}';
$string['updaterequest'] = 'Update request from Moodiy';
